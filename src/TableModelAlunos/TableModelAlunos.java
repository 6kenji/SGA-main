...
public class TableModelAlunos extends AbstractTableModel{
	...
	private String[] colunas = {"ID","NOME","APELIDO","NACIONALIDADE","SEXO"};
	...
	public Object getValueAt(int linha, int coluna) {
		...
		case 3 :return dados.get(linha).getNacionalidade();
	...
	public void setValueAt(Object valor, int linha, int coluna) {
		// TODO Auto-generated method stub
		UUID ID = UUID.fromString((String) valor);
		switch(coluna) {
		
		case 0 : dados.get(linha).setId(ID);break;
		
		case 1 : dados.get(linha).setNome((String) valor);break;

		case 2 : dados.get(linha).setApelido((String) valor);break;
                
                case 3 : dados.get(linha).setNacionalidade((String) valor);break;
